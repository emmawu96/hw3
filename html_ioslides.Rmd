...
The gray dots are Sector "Tucson", which has the most unstable number of apprehensions. And it also contributed the most apprehensions in 2010. 
```{r}
#PB2010 <- read.csv("PB2010.csv")
...
The pink dots are Sector "Rio Grande Valley" which contributed the most apprehensions in 2017. Notably,the number of apprehensions from Rio Grande Valley is unstable, especially it dramatically increased from October to December.
```{r}
#PB2017 <- read.csv("PB2017.csv")
...
While apprehensions tend to decrease during the winter months, we can see an increase from January to February from 2010 to 2017.
```{r echo=FALSE}
#ap10 <- read.csv("BP apprehensions 2010.csv")
cities <- ap10[,1]
ap10 <- ap10[-c(1,14)]
